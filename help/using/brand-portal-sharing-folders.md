...
Tenzij de **[!UICONTROL Public Folder Publish]** optie is geselecteerd tijdens het configureren van de replicatie van het Brand Portal, hebben gebruikers die geen beheerder zijn (zoals Editors en Viewers) geen toegang tot de middelen die van AEM Assets naar het Brand Portal zijn gepubliceerd.
...
>[!NOTE]
>
>Standaard is de **[!UICONTROL Public Folder Publish]** optie uitgeschakeld tijdens het configureren van replicatie van Brand Portal met AEM-auteur. Als de optie is ingeschakeld, zijn de mappen die naar het Brand Portal worden gepubliceerd standaard toegankelijk voor alle gebruikers (ook niet-beheerders).
