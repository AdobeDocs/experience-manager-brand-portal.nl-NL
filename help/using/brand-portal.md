...
Merk op dat alleen het voorvoegsel van de Brand Portal URL kan worden aangepast en niet de volledige URL. Een organisatie met een bestaand domein `geomettrix.brand-portal.adobe.com` kan bijvoorbeeld `geomettrixinc.brand-portal.adobe.com` op verzoek ophalen.
